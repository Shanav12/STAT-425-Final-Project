...
# We want to test the null-hypothesis that bmi is irrelevant to charges
...
# P-value = 2.2e-16 < 0.05, we reject the null hypothesis, indicating that bmi is not useful.
```
